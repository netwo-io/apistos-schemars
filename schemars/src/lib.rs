...
/// ```
///# extern crate apistos_schemars as schemars;
/// use schemars::{generator::SchemaGenerator, schema::Schema, JsonSchema};
/// use std::borrow::Cow;
///
...
pub trait JsonSchema {
    ...
    /// add them to the [`SchemaGenerator`](generator::SchemaGenerator)'s schema definitions.
    ///
    ...
    fn _schemars_private_non_optional_json_schema(
        generator: &mut generator::SchemaGenerator,
    ) -> Schema {
...
pub mod tests {
    ...
    pub fn schema_for<T: JsonSchema>() -> schema::Schema {
        let mut generator = generator::SchemaGenerator::default();
